/* Generated by re2c 0.13.6 on Mon Jun 15 04:13:03 2015 */
#include <stdlib.h>
#include "chunk.h"
#include "scanners.h"
...
yy1423:
	yych = *++p;
	if (yych == 'J') goto yy1424;
	if (yych != 'j') goto yy1315;
yy1424:
	yych = *++p;
...
yy1592:
	yych = *++p;
	if (yych == 'S') goto yy1593;
	if (yych != 's') goto yy1315;
yy1593:
	++p;
	if ((yych = *p) == 'S') goto yy1474;
	if (yych == 's') goto yy1474;
	goto yy1315;
}
