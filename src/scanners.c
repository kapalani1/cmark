...
yy1291:
	...
	if (yych <= 0x1F) {
		if (yych <= 0x08) goto yy1263;
		if (yych >= 0x0E) goto yy1263;
	} else {
		if (yych <= ' ') goto yy1293;
		if (yych == '>') goto yy1265;
		goto yy1263;
...
yy1331:
	...
	if (yych <= 'Q') {
		if (yych <= 'D') {
			...
			if (yych <= '6') goto yy1488;
			goto yy1329;
		} else {
			if (yych <= 'E') goto yy1587;
			if (yych == 'G') goto yy1586;
			goto yy1329;
		}
	} else {
		if (yych <= 'f') {
...
yy1374:
	yych = *++p;
	if (yych == 'P') goto yy1375;
	if (yych != 'p') goto yy1329;
yy1375:
	yych = *++p;
...
yy1437:
	yych = *++p;
	if (yych == 'J') goto yy1438;
	if (yych != 'j') goto yy1329;
yy1438:
	yych = *++p;
...
yy1572:
	yych = *++p;
	if (yych == 'K') goto yy1573;
	if (yych != 'k') goto yy1329;
yy1573:
	yych = *++p;
	if (yych == 'Q') goto yy1574;
	if (yych != 'q') goto yy1329;
yy1574:
	yych = *++p;
...
yy1623:
	...
	if (yych <= '@') {
		if (yych <= ' ') goto yy1622;
		if (yych <= '/') goto yy1620;
		if (yych <= '9') goto yy1622;
		goto yy1620;
	} else {
		if (yych <= '`') {
			if (yych <= 'Z') goto yy1622;
			goto yy1620;
		} else {
			if (yych <= 'z') goto yy1622;
			if (yych <= '~') goto yy1620;
